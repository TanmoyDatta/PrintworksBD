...
public class AllInformationPage extends BasePage{
	...
	public void InformationAll() throws InterruptedException {
		...
		writeTextOnElement(Address,"Mirpur-1 , Dhaka");
		//actions.scrollToElement(b_address).build().perform();
		Thread.sleep(1000);
		b_address.sendKeys("Sukhrabad, Dhanmondhi 32, Dhaka");
		Thread.sleep(1000);
		writeTextOnElement(PostCode,"Dhaka 1216");
		Thread.sleep(1000);
		writeTextOnElement(Phone,"01789456123");
		Thread.sleep(2000);
		mail.clear();
